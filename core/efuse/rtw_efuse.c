...
BOOLEAN rtw_file_efuse_IsMasked(PADAPTER pAdapter, u16 Offset, u8 *maskbuf) {
    ...
    if (pAdapter->registrypriv.boffefusemask) return FALSE;
...
#ifdef CONFIG_BT_EFUSE_MASK
#ifdef CONFIG_USB_HCI
    if (IS_HARDWARE_TYPE_8822CU(pAdapter)) GET_MASK_ARRAY(8822C, _MUSB, pArray);
#endif
#ifdef CONFIG_PCI_HCI
...
#ifdef CONFIG_USB_HCI
#if defined(CONFIG_RTL8188E)
    if (IS_HARDWARE_TYPE_8188E(pAdapter)) GET_MASK_ARRAY(8188E, _MUSB, pArray);
#endif
#if defined(CONFIG_RTL8812A)
    if (IS_HARDWARE_TYPE_8812(pAdapter)) GET_MASK_ARRAY(8812A, _MUSB, pArray);
#endif
#if defined(CONFIG_RTL8821A)
    if (IS_HARDWARE_TYPE_8821(pAdapter)) GET_MASK_ARRAY(8821A, _MUSB, pArray);
#endif
#if defined(CONFIG_RTL8192E)
    if (IS_HARDWARE_TYPE_8192E(pAdapter)) GET_MASK_ARRAY(8192E, _MUSB, pArray);
#endif
#if defined(CONFIG_RTL8723B)
    if (IS_HARDWARE_TYPE_8723B(pAdapter)) GET_MASK_ARRAY(8723B, _MUSB, pArray);
#endif
#if defined(CONFIG_RTL8703B)
    if (IS_HARDWARE_TYPE_8703B(pAdapter)) GET_MASK_ARRAY(8703B, _MUSB, pArray);
#endif
#if defined(CONFIG_RTL8188F)
    if (IS_HARDWARE_TYPE_8188F(pAdapter)) GET_MASK_ARRAY(8188F, _MUSB, pArray);
#endif
#if defined(CONFIG_RTL8188GTV)
    if (IS_HARDWARE_TYPE_8188GTV(pAdapter))
...
#endif
#if defined(CONFIG_RTL8814A)
    if (IS_HARDWARE_TYPE_8814A(pAdapter)) GET_MASK_ARRAY(8814A, _MUSB, pArray);
#endif
#if defined(CONFIG_RTL8822B)
    if (IS_HARDWARE_TYPE_8822B(pAdapter)) GET_MASK_ARRAY(8822B, _MUSB, pArray);
#endif
#if defined(CONFIG_RTL8821C)
    if (IS_HARDWARE_TYPE_8821CU(pAdapter)) GET_MASK_ARRAY(8821C, _MUSB, pArray);
#endif
#if defined(CONFIG_RTL8192F)
    if (IS_HARDWARE_TYPE_8192FU(pAdapter)) GET_MASK_ARRAY(8192F, _MUSB, pArray);
#endif
#if defined(CONFIG_RTL8822C)
    if (IS_HARDWARE_TYPE_8822C(pAdapter)) GET_MASK_ARRAY(8822C, _MUSB, pArray);
#endif
#if defined(CONFIG_RTL8814B)
    if (IS_HARDWARE_TYPE_8814B(pAdapter)) GET_MASK_ARRAY(8814B, _MUSB, pArray);
#endif
#endif /*CONFIG_USB_HCI*/

#ifdef CONFIG_PCI_HCI
#if defined(CONFIG_RTL8188E)
    if (IS_HARDWARE_TYPE_8188E(pAdapter)) GET_MASK_ARRAY(8188E, _MPCIE, pArray);
#endif
#if defined(CONFIG_RTL8192E)
    if (IS_HARDWARE_TYPE_8192E(pAdapter)) GET_MASK_ARRAY(8192E, _MPCIE, pArray);
#endif
#if defined(CONFIG_RTL8812A)
    if (IS_HARDWARE_TYPE_8812(pAdapter)) GET_MASK_ARRAY(8812A, _MPCIE, pArray);
#endif
#if defined(CONFIG_RTL8821A)
    if (IS_HARDWARE_TYPE_8821(pAdapter)) GET_MASK_ARRAY(8821A, _MPCIE, pArray);
#endif
#if defined(CONFIG_RTL8723B)
    if (IS_HARDWARE_TYPE_8723B(pAdapter)) GET_MASK_ARRAY(8723B, _MPCIE, pArray);
#endif
#if defined(CONFIG_RTL8814A)
    if (IS_HARDWARE_TYPE_8814A(pAdapter)) GET_MASK_ARRAY(8814A, _MPCIE, pArray);
#endif
#if defined(CONFIG_RTL8822B)
    if (IS_HARDWARE_TYPE_8822B(pAdapter)) GET_MASK_ARRAY(8822B, _MPCIE, pArray);
#endif
#if defined(CONFIG_RTL8821C)
    if (IS_HARDWARE_TYPE_8821CE(pAdapter))
...
#endif
#if defined(CONFIG_RTL8822C)
    if (IS_HARDWARE_TYPE_8822C(pAdapter)) GET_MASK_ARRAY(8822C, _MPCIE, pArray);
#endif
#if defined(CONFIG_RTL8814B)
    if (IS_HARDWARE_TYPE_8814B(pAdapter)) GET_MASK_ARRAY(8814B, _MPCIE, pArray);
#endif
#endif /*CONFIG_PCI_HCI*/

#ifdef CONFIG_SDIO_HCI
#if defined(CONFIG_RTL8188E)
    if (IS_HARDWARE_TYPE_8188E(pAdapter)) GET_MASK_ARRAY(8188E, _MSDIO, pArray);
#endif
#if defined(CONFIG_RTL8723B)
    if (IS_HARDWARE_TYPE_8723BS(pAdapter))
...
#endif
#if defined(CONFIG_RTL8188F)
    if (IS_HARDWARE_TYPE_8188F(pAdapter)) GET_MASK_ARRAY(8188F, _MSDIO, pArray);
#endif
#if defined(CONFIG_RTL8188GTV)
    if (IS_HARDWARE_TYPE_8188GTV(pAdapter))
...
#endif
#if defined(CONFIG_RTL8821A)
    if (IS_HARDWARE_TYPE_8821S(pAdapter)) GET_MASK_ARRAY(8821A, _MSDIO, pArray);
#endif
#if defined(CONFIG_RTL8821C)
    if (IS_HARDWARE_TYPE_8821CS(pAdapter))
...
#endif
#if defined(CONFIG_RTL8822B)
    if (IS_HARDWARE_TYPE_8822B(pAdapter)) GET_MASK_ARRAY(8822B, _MSDIO, pArray);
#endif
#if defined(CONFIG_RTL8192F)
    if (IS_HARDWARE_TYPE_8192FS(pAdapter))
...
#endif
#if defined(CONFIG_RTL8822C)
    if (IS_HARDWARE_TYPE_8822C(pAdapter)) GET_MASK_ARRAY(8822C, _MSDIO, pArray);
#endif
#endif /*CONFIG_SDIO_HCI*/
}
        ...
        for (i = 0; i < cnts; i++) {
            if (padapter->registrypriv.bFileMaskEfuse == _TRUE) {
                if (rtw_file_efuse_IsMasked(
                        padapter, addr + i,
                        maskfileBuffer)) /*use file efuse mask.*/
                    data[i] = 0xff;
                else
                    RTW_DBG("data[%x] = %x\n", i, data[i]);
            } else {
...
static u8 hal_EfuseSwitchToBank(PADAPTER padapter, u8 bank, u8 bPseudoTest) {
    ...
    if (bPseudoTest) {
        ...
        switch (bank) {
            case 0:
                value32 =
                    (value32 & ~EFUSE_SEL_MASK) | EFUSE_SEL(EFUSE_WIFI_SEL_0);
                break;
            case 1:
                value32 =
                    (value32 & ~EFUSE_SEL_MASK) | EFUSE_SEL(EFUSE_BT_SEL_0);
                break;
            case 2:
                value32 =
                    (value32 & ~EFUSE_SEL_MASK) | EFUSE_SEL(EFUSE_BT_SEL_1);
                break;
            case 3:
                value32 =
                    (value32 & ~EFUSE_SEL_MASK) | EFUSE_SEL(EFUSE_BT_SEL_2);
                break;
            default:
                value32 =
                    (value32 & ~EFUSE_SEL_MASK) | EFUSE_SEL(EFUSE_WIFI_SEL_0);
...
void rtw_efuse_analyze(PADAPTER padapter, u8 Type, u8 Fake) {
    ...
    RTW_INFO(
        "\n\r 2Byte header, extHeader[7:4]=offset[6:3], extHeader[3:0]=word "
        "enable\n");
    ...
    EFUSE_GetEfuseDefinition(padapter, efuseType, TYPE_EFUSE_PROTECT_BYTES_BANK,
    ...
    for (bank = startBank; bank <= endBank; bank++) {
        ...
        while ((efuseHeader != 0xFF) &&
            ...
            if (EXT_HEADER(efuseHeader)) {
                ...
                if (efuseExtHdr != 0xff) {
                    if (ALL_WORDS_DISABLED(efuseExtHdr)) {
                        ...
                        RTW_INFO(
                            "Find efuseHeader2Byte = 0x%04X, offset=%d, "
                            "wden=0x%x\n",
                ...
                for (i = 0; i < EFUSE_MAX_WORD_UNIT; i++) {
                    ...
                    if (!(wden & (0x01 << i))) {
                        if (!((efuseType == EFUSE_WIFI &&
                               (eFuse_Addr + 2 < maprawlen)) ||
                              (efuseType == EFUSE_BT &&
                               (eFuse_Addr + 2 <
                                (endBank + 1) * EFUSE_MAX_BANK_SIZE)))) {
                            RTW_INFO("eFuse_Addr exceeds, break\n");
                            break;
                        }
                        efuse_OneByteRead(padapter, eFuse_Addr++,
                                          &efuseData[dataCnt++], bPseudoTest);
                        eFuseWord[(offset * 8) + (i * 2)] =
                            (efuseData[dataCnt - 1]);
                        efuse_OneByteRead(padapter, eFuse_Addr++,
                                          &efuseData[dataCnt++], bPseudoTest);
                        eFuseWord[(offset * 8) + (i * 2 + 1)] =
                            (efuseData[dataCnt - 1]);
                    }
                }
            }
            ...
            for (j = 0; j < dataCnt; j++) RTW_INFO(" %02X ", efuseData[j]);
            ...
            RTW_INFO("offset=0x%x(%d), word enable=0x%x\n", ParseOffset,
                     ParseOffset, ParseWDEN);

            wd_cnt = 0;
            for (i = 0; i < EFUSE_MAX_WORD_UNIT; i++) {
                if (!(wden & (0x01 << i))) {
                    RTW_INFO("Map[ %02X ] = %02X %02X\n",
                             ((offset * EFUSE_MAX_WORD_UNIT * 2) + (i * 2)),
        ...
        if (!bCheckNextBank) {
            RTW_INFO(
                "Not need to check next bank, eFuse_Addr=%d, "
    ...
    for (i = 0; i < mapLen; i++) {
        if (i % 16 == 0) RTW_PRINT_SEL(RTW_DBGDUMP, "0x%03x: ", i);
...
void efuse_PreUpdateAction(PADAPTER pAdapter, u32 *BackupRegs) {
    if (IS_HARDWARE_TYPE_8812AU(pAdapter) ||
        IS_HARDWARE_TYPE_8822BU(pAdapter)) {
        /* <20131115, Kordan> Turn off Rx to prevent from being busy when
         * writing the EFUSE. (Asked by Chunchu.)*/
...
#ifdef CONFIG_RTL8812A
        /* <20140410, Kordan> 0x11 = 0x4E, lower down LX_SPS0 voltage. (Asked by
         * Chunchu)*/
...
void efuse_PostUpdateAction(PADAPTER pAdapter, u32 *BackupRegs) {
    if (IS_HARDWARE_TYPE_8812AU(pAdapter) ||
        IS_HARDWARE_TYPE_8822BU(pAdapter)) {
        /* <20131115, Kordan> Turn on Rx and restore the registers. (Asked by
         * Chunchu.)*/
...
u8 efuse_bt_GetCurrentSize(PADAPTER adapter, u16 *usesize) {
    ...
    *usesize = fakeBTEfuseUsedBytes;
    ...
    if (efuse_map) rtw_mfree(efuse_map, EFUSE_BT_MAP_LEN);

    return _SUCCESS;
}

u16 efuse_bt_GetMaxSize(PADAPTER adapter) { return EFUSE_BT_REAL_CONTENT_LEN; }
...
u8 rtw_efuse_access(PADAPTER adapter, u8 write, u16 addr, u16 cnts, u8 *data) {
    ...
    if ((addr + cnts) > size) return _FAIL;

    if (_TRUE == write) {
        err = rtw_halmac_write_physical_efuse(d, addr, cnts, data);
        if (err) return _FAIL;
    } else {
        if (cnts > 16) efuse = rtw_zmalloc(size);
...
static inline void dump_buf(u8 *buf, u32 len) {
    ...
    RTW_INFO("-----------------Len %d----------------\n", len);
    for (i = 0; i < len; i++) printk("%2.2x-", *(buf + i));
    printk("\n");
}
...
u8 rtw_efuse_bt_access(PADAPTER adapter, u8 write, u16 addr, u16 cnts,
    ...
    if (_TRUE == write) {
        ...
        if (efuse) {
            ...
            RTW_INFO(
                "%s: rtw_halmac_read_bt_physical_efuse_map ok! data 0x%x\n",
                __FUNCTION__, *data);
            rtw_mfree(efuse, size);
        }
    }
...
static void rtw_bt_mask_map_read(PADAPTER padapter, u16 addr, u16 cnts,
                                 u8 *data) {
    u16 i = 0;
    ...
    if (padapter->registrypriv.boffefusemask == 0) {
        for (i = 0; i < cnts; i++) {
            if (padapter->registrypriv.bBTFileMaskEfuse == _TRUE) {
                if (rtw_file_efuse_IsMasked(
                        padapter, addr + i,
                        btmaskfileBuffer)) /*use BT file efuse mask.*/
                    data[i] = 0xff;
                else
                    RTW_DBG("data[%x] = %x\n", i, data[i]);
            } else {
                if (efuse_IsBT_Masked(
                        padapter, addr + i)) /*use drv internal efuse mask.*/
                    data[i] = 0xff;
                else
                    RTW_DBG("data[%x] = %x\n", i, data[i]);
            }
...
static u16 hal_EfuseGetCurrentSize_BT(PADAPTER padapter, u8 bPseudoTest) {
    ...
    for (bank = startBank; bank < 3; bank++) {
        ...
        if (bank != startBank) efuse_addr = 0;
        ...
        while (AVAILABLE_EFUSE_ADDR(efuse_addr)) {
            ...
            RTW_INFO(
                "%s: efuse_OneByteRead ! addr=0x%X !efuse_data=0x%X! bank "
                "=%d\n",
            ...
            if (EXT_HEADER(efuse_data)) {
                ...
                rtw_efuse_bt_access(padapter, _FALSE, efuse_addr, 1,
                                    &efuse_data);
                RTW_INFO(
                    "%s: efuse_OneByteRead EXT_HEADER ! addr=0x%X "
        ...
        if (efuse_addr < retU2) break; /* don't need to check next bank. */
    }
...
#define RT_ASSERT_RET(expr)                                                \
    ...
    if ((addr + cnts) > mapLen) return _FAIL;
    ...
    if (adapter->registrypriv.boffefusemask == 0) {
        for (i = 0; i < cnts; i++) {
            if (adapter->registrypriv.bFileMaskEfuse == _TRUE) {
                if (rtw_file_efuse_IsMasked(
                        adapter, addr + i,
                        btmaskfileBuffer)) /*use file efuse mask. */
    ...
    while (idx < cnts) {
        ...
        for (i = j; i < PGPKT_DATA_SIZE && idx < cnts; i++, idx++) {
            if (efuse[addr + idx] != map[addr + idx]) word_en &= ~BIT(i >> 1);
        }

        if (word_en != 0xF) {
            chk_total_byte += Efuse_CalculateWordCnts(word_en) * 2;

            if (offset >= EFUSE_MAX_SECTION_BASE) /* Over EFUSE_MAX_SECTION 16
                                                     for 2 ByteHeader */
                chk_total_byte += 2;
            else
                chk_total_byte += 1;
    ...
    if (!AVAILABLE_EFUSE_ADDR(startAddr + chk_total_byte)) {
        RTW_INFO(
            "%s: startAddr(0x%X) + PG data len %d >= efuse BT available offset "
            "(0x%X)\n",
    ...
    while (idx < cnts) {
        ...
        if (word_en != 0xF) {
            ret = EfusePgPacketWrite_BT(adapter, offset, word_en, newdata,
                                        _FALSE);
            RTW_INFO("offset=%x\n", offset);
            RTW_INFO("word_en=%x\n", word_en);
...
void hal_ReadEFuse_BT_logic_map(PADAPTER padapter, u16 _offset, u16 _size_byte,
    ...
    for (bank = 1; bank <= total; bank++) { /* 8723d Max bake 0~2 */
        ...
        while (AVAILABLE_EFUSE_ADDR(eFuse_Addr)) {
            ...
            RTW_INFO(
                "%s: efuse[%#X]=0x%02x (header)\n", __FUNCTION__,
                (((bank - 1) * EFUSE_BT_REAL_CONTENT_LEN) + eFuse_Addr - 1),
                efuseHeader);
            ...
            if (EXT_HEADER(efuseHeader)) { /* extended header */
                ...
                RTW_INFO(
                    ...
                    (((bank - 1) * EFUSE_BT_REAL_CONTENT_LEN) + eFuse_Addr - 1),
                    efuseExtHdr);
                if (ALL_WORDS_DISABLED(efuseExtHdr)) continue;
            ...
            if (offset < EFUSE_BT_MAX_SECTION) {
                ...
                for (i = 0; i < EFUSE_MAX_WORD_UNIT; i++) {
                    ...
                    if (!(wden & (0x01 << i))) {
                        efuseData = 0;
                        /* ReadEFuseByte(padapter, eFuse_Addr++, &efuseData,
                         * bPseudoTest); */
    ...
    for (i = 0; i < _size_byte; i++) pbuf[i] = efuseTbl[_offset + i];
...
exit:
    if (efuseTbl) rtw_mfree(efuseTbl, EFUSE_BT_MAP_LEN);
...
static u8 hal_EfusePartialWriteCheck(PADAPTER padapter, u8 efuseType,
                                     ...
                                     u8 bPseudoTest) {
    u8 bRet = _FALSE;
    u16 startAddr = 0, efuse_max_available_len = EFUSE_BT_REAL_BANK_CONTENT_LEN,
    ...
    while (1) {
        ...
        if (rtw_efuse_bt_access(padapter, _FALSE, startAddr, 1, &efuse_data) &&
            ...
            bRet = _FALSE;
            RTW_INFO(
                "%s: Something Wrong! last bytes(%#X=0x%02X) is not 0xFF\n",
                __FUNCTION__, startAddr, efuse_data);
            break;
        } else {
            /* not used header, 0xff */
            *pAddr = startAddr;
            /*			RTW_INFO("%s: Started from unused header
             * offset=%d\n",
             * __FUNCTION__, startAddr)); */
            bRet = _TRUE;
            break;
...
u8 EfusePgPacketWrite_BT(PADAPTER pAdapter, u8 offset, u8 word_en, u8 *pData,
    ...
    if (!hal_BT_EfusePgCheckAvailableAddr(pAdapter, bPseudoTest)) return _FALSE;
...
BOOLEAN
Efuse_Read1ByteFromFakeContent(PADAPTER pAdapter, u16 Offset, u8 *Value);
BOOLEAN
Efuse_Read1ByteFromFakeContent(PADAPTER pAdapter, u16 Offset, u8 *Value) {
    if (Offset >= EFUSE_MAX_HW_SIZE) return _FALSE;
...
BOOLEAN
Efuse_Write1ByteToFakeContent(PADAPTER pAdapter, u16 Offset, u8 Value);
BOOLEAN
Efuse_Write1ByteToFakeContent(PADAPTER pAdapter, u16 Offset, u8 Value) {
    if (Offset >= EFUSE_MAX_HW_SIZE) return _FALSE;
    if (fakeEfuseBank == 0)
 ...
 *				pwr on state. When we stop write, we should switch
 *to 500k mode and disable LDO 2.5V.
 *
 * Input:       NONE
 *
 * Output:      NONE
...
void ReadEFuseByte(PADAPTER Adapter, u16 _offset, u8 *pbuf,
    ...
    if (IS_HARDWARE_TYPE_8723B(Adapter)) {
        ...
        /* 0x34[11]: SW force PGMEN input of efuse to high. (for the bank
     ...
     */
    /* Designer says that there shall be some delay after ready bit is set, or
     * the */
 ...
 *again!!! Sec1 write addr must be after sec5.
 *   */
...
u8 efuse_OneByteWrite(PADAPTER pAdapter, u16 addr, u8 data,
    ...
    if (tmpidx < 100)
        ...
        bResult = _FALSE;
        RTW_INFO(
            "%s: [ERROR] addr=0x%x ,efuseValue=0x%x ,bResult=%d time out 1s "
            "!!!\n",
...
int Efuse_PgPacketWrite_BT(PADAPTER pAdapter, u8 offset, u8 word_en, u8 *data,
                           BOOLEAN bPseudoTest) {
    int ret;
...
u8 rtw_efuse_access(PADAPTER padapter, u8 bWrite, u16 start_addr, u16 cnts,
    ...
    EFUSE_GetEfuseDefinition(padapter, EFUSE_WIFI, TYPE_EFUSE_REAL_CONTENT_LEN,
                             (void *)&real_content_len, _FALSE);
    EFUSE_GetEfuseDefinition(padapter, EFUSE_WIFI,
                             TYPE_AVAILABLE_EFUSE_BYTES_TOTAL,
                             (void *)&max_available_size, _FALSE);

    if (start_addr > real_content_len) return _FAIL;

    if (_TRUE == bWrite) {
        if ((start_addr + cnts) > max_available_size) return _FAIL;
        rw8 = &efuse_write8;
    } else
        rw8 = &efuse_read8;
...
#define RT_ASSERT_RET(expr)                                            \
    ...
    if (padapter->registrypriv.boffefusemask == 0) {
        for (i = 0; i < cnts; i++) {
            ...
            RTW_INFO("%s , data[%d] = %x, map[addr+i]= %x\n", __func__,
                     addr + i, efuse[addr + i], map[addr + i]);
        }
    }
    /*Efuse_PowerSwitch(padapter, _TRUE, _TRUE);*/
    ...
    if ((startAddr + chk_total_byte) >= efuse_max_available_len) {
        RTW_INFO(
            "%s: startAddr(0x%X) + PG data len %d >= "
    ...
    while (idx < cnts) {
                ...
                if (addr + idx == 0x8) {
                    if (IS_C_CUT(pHalData->version_id) ||
                        ...
                        if (pHalData->adjuseVoltageVal == 6) {
                            ...
                            RTW_INFO(
                                " %s ,\n adjuseVoltageVal = %d ,newdata[%d] = "
                                "%x\n",
                                __func__, pHalData->adjuseVoltageVal, i,
                                newdata[i]);
                        }
                    }
                }
        ...
        if (word_en != 0xF) {
            ret =
                Efuse_PgPacketWrite(padapter, offset, word_en, newdata, _FALSE);
            RTW_INFO("offset=%x\n", offset);
            RTW_INFO("word_en=%x\n", word_en);
...
#define RT_ASSERT_RET(expr)                                            \
    ...
    for (i = 0; i < 1024;
         i +=
         16) { /* set 512 because the iwpriv's extra size have limit 0x7FF */
        RTW_INFO("0x%03x\t", i);
        for (j = 0; j < 8; j++) RTW_INFO("%02X ", map[i + j]);
        RTW_INFO("\t");
        for (; j < 16; j++) RTW_INFO("%02X ", map[i + j]);
        RTW_INFO("\n");
    }
    RTW_INFO("\n");
    Efuse_PowerSwitch(padapter, _TRUE, _TRUE);
 ...
 *
 *---------------------------------------------------------------------------*/
void Efuse_ReadAllMap(PADAPTER pAdapter, u8 efuseType, u8 *Efuse,
                      BOOLEAN bPseudoTest);
void Efuse_ReadAllMap(PADAPTER pAdapter, u8 efuseType, u8 *Efuse,
                      BOOLEAN bPseudoTest) {
    u16 mapLen = 0;
 ...
 *---------------------------------------------------------------------------*/
#ifdef PLATFORM
static void efuse_ShadowWrite1Byte(PADAPTER pAdapter, u16 Offset, u8 Value);
#endif /* PLATFORM */
static void efuse_ShadowWrite1Byte(PADAPTER pAdapter, u16 Offset, u8 Value) {
    PHAL_DATA_TYPE pHalData = GET_HAL_DATA(pAdapter);
...
/* ---------------Write Two Bytes */
static void efuse_ShadowWrite2Byte(PADAPTER pAdapter, u16 Offset, u16 Value) {
    PHAL_DATA_TYPE pHalData = GET_HAL_DATA(pAdapter);
...
/* ---------------Write Four Bytes */
static void efuse_ShadowWrite4Byte(PADAPTER pAdapter, u16 Offset, u32 Value) {
    PHAL_DATA_TYPE pHalData = GET_HAL_DATA(pAdapter);
 ...
 *
 *---------------------------------------------------------------------------*/
void EFUSE_ShadowWrite(PADAPTER pAdapter, u8 Type, u16 Offset, u32 Value);
void EFUSE_ShadowWrite(PADAPTER pAdapter, u8 Type, u16 Offset, u32 Value) {
#if (MP_DRIVER == 0)
    return;
#endif
    if (pAdapter->registrypriv.mp_mode == 0) return;
 ...
 *
 *---------------------------------------------------------------------------*/
static void efuse_ShadowRead1Byte(PADAPTER pAdapter, u16 Offset, u8 *Value) {
    PHAL_DATA_TYPE pHalData = GET_HAL_DATA(pAdapter);
...
/* ---------------Read Two Bytes */
static void efuse_ShadowRead2Byte(PADAPTER pAdapter, u16 Offset, u16 *Value) {
    PHAL_DATA_TYPE pHalData = GET_HAL_DATA(pAdapter);
...
/* ---------------Read Four Bytes */
static void efuse_ShadowRead4Byte(PADAPTER pAdapter, u16 Offset, u32 *Value) {
    PHAL_DATA_TYPE pHalData = GET_HAL_DATA(pAdapter);
...
void EFUSE_ShadowMapUpdate(PADAPTER pAdapter, u8 efuseType,
    ...
    if (mapLen > EEPROM_MAX_SIZE) {
        RTW_WARN(
            "%s: <ERROR> size of efuse data(%d) is large than expected(%d)!\n",
    ...
    if (pHalData->bautoload_fail_flag == _FALSE) {
        ...
        if (err) RTW_ERR("%s: <ERROR> fail to get efuse map!\n", __FUNCTION__);
    }
#else /* !RTW_HALMAC */
    EFUSE_GetEfuseDefinition(pAdapter, efuseType, TYPE_EFUSE_MAP_LEN,
                             (void *)&mapLen, bPseudoTest);
...
u8 mac_hidden_wl_func_to_hal_wl_func(u8 func) {
    ...
    if (func & BIT0) wl_func |= WL_FUNC_MIRACAST;
    if (func & BIT1) wl_func |= WL_FUNC_P2P;
    if (func & BIT2) wl_func |= WL_FUNC_TDLS;
    if (func & BIT3) wl_func |= WL_FUNC_FTM;
...
int isAdaptorInfoFileValid(void) { return _TRUE; }
...
exit:
    if (file_data) rtw_vmfree(file_data, file_size);
    if (map) rtw_vmfree(map, map_size);
